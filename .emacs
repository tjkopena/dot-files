...
(autoload 'yaml-mode "yaml-mode" "A major mode for editing YAML files." t)
;;(require 'yaml-mode)
...
(defun reb-replace-regexp (&optional delimited)
  "Run `query-replace-regexp' with the contents of re-builder. With non-nil optional argument DELIMITED, only replace matches surrounded by word boundaries."
  (interactive "P")
  (reb-update-regexp)
...
(global-set-key (kbd "M-%") #'re-builder)
